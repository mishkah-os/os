...
const httpServer = createServer(async (req, res) => {
  ...
  // List all available schemas (global + branch-specific)
  ...
  // Get a specific schema (global or branch-specific)
  ...
  // Save a schema (global or branch-specific)
  ...
  // ==================== SEEDS MANAGEMENT API ====================

  // Save seeds (batch insert for selected tables)
  ...
  if (url.pathname.startsWith('/api/pwa')) {
    await handlePwaApi(req, res, url);
    return;
  }
