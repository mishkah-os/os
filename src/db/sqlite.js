...
const DEFAULT_TABLES = new Set([
  ...
  'order_payment',
  'pos_shift'
  // 🔧 NOTE: job_order_* tables are TRANSIENT (in-memory only)
  // They don't have branch_id/module_id columns and are meant for live kitchen sync
  // Data is broadcast via WebSocket and doesn't need long-term persistence
]);
